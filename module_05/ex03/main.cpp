...
int main() {
	...
	std::cout << "---------------------------------------" << std::endl;
	try {
		std::cout << "Try to create presidential form with Intern\n";
		f = i.makeForm("presidential pardon", "Navalny");
		std::cout << *f << std::endl;
		delete f;
	}
	catch (std::exception &e) {
	...
	std::cout << "---------------------------------------" << std::endl;
	try {
		std::cout << "Try to create Robotomy form with Intern\n";
		f = i.makeForm("robotomy request", "taxi");
		std::cout << *f << std::endl;
		delete f;
	}
	catch (std::exception &e) {
	...
	std::cout << "---------------------------------------" << std::endl;
	try {
		std::cout << "Try to create shrubbery creation form with Intern\n";
	...
	std::cout << "---------------------------------------" << std::endl;
	try {
		std::cout << "Try to sign shrubbery creation form with low grade with bureaucrat method\n";
	...
	std::cout << "---------------------------------------" << std::endl;
	try {
		std::cout << "success sign and exec shrubbery creation form with Intern\n";
		f = i.makeForm("shrubbery creation", "park");
		Bureaucrat b("b", 50);
		b.signForm(*f);
		b.executeForm(*f);
	...
	std::cout << "---------------------------------------" << std::endl;
	try {
		std::cout << "success sign and exec presidential form with Intern\n";
		f = i.makeForm("presidential pardon", "Navalny");
		Bureaucrat b("b", 1);
		b.signForm(*f);
		b.executeForm(*f);
	...
	std::cout << "---------------------------------------" << std::endl;
	try {
		std::cout << "success sign and exec robotomy form with Intern\n";
		f = i.makeForm("robotomy request", "taxi");
		Bureaucrat b("b", 1);
		b.signForm(*f);
		b.executeForm(*f);
